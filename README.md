...
Many papers and documents refer to music visualization as a hard problem to solve, ML algorithms are using some kind of piano roll or midi as data source and are encoded/decoded piano based, writing and reading music software has also some issues for mapping notes when using piano as writing machine, and music has a steep learning rate. We think that some of this issues could be solved using this system which gathers and represent information from a stave simpler and better than any other one so far.  
...
- [Magenta - https://magenta.tensorflow.org/ceg-and-cocochorales](https://magenta.tensorflow.org/ceg-and-cocochorales)
