...
Nowadays AI is mature enough for bringing models that might allow to explore the whole potential, and **Jaime** wants to open source a better music education and comprehension for the mandkind. 
**Let's help him!**
We are just starting, follow [issues](https://github.com/users/localaization/projects/1)
